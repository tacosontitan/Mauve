...
namespace Mauve
{
    ...
    /// <typeparam name="T5">Specifies the fifth type of input for the operation.</typeparam>
    ...
    public interface IExecutable<T1, T2, T3, T4, T5, TOut>
    {
        ...
        Task<TOut> Execute(T1 input1, T2 input2, T3 input3, T4 input4, T5 input5, CancellationToken cancellationToken);
    }
}
