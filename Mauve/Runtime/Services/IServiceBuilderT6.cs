...
{
    /// <summary>
    /// An <see cref="interface"/> capable of building an <see cref="IService{T1, T2, T3, T4, T5, T6}"/>.
    /// </summary>
    ...
    public interface IServiceBuilder<T1, T2, T3, T4, T5, T6> : IBuilder<IService<T1, T2, T3, T4, T5, T6>>
    {
        /// <summary>
        ...
        /// <returns>Returns the current <see cref="IServiceBuilder{T1, T2, T3, T4, T5, T6}"/> instance.</returns>
