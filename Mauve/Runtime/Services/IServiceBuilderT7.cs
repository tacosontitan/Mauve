...
{
    /// <summary>
    /// An <see cref="interface"/> capable of building an <see cref="IService{T1, T2, T3, T4, T5, T6, T7}"/>.
    /// </summary>
    ...
    public interface IServiceBuilder<T1, T2, T3, T4, T5, T6, T7> : IBuilder<IService<T1, T2, T3, T4, T5, T6, T7>>
    {
        ...
        /// <returns>Returns the current <see cref="IServiceBuilder{T1, T2, T3, T4, T5, T6, T7}"/> instance.</returns>
