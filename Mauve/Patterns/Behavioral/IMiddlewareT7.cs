...
namespace Mauve.Patterns
{
    ...
    public interface IMiddleware<T1, T2, T3, T4, T5, T6, T7>
    {
        /// <summary>
        ...
        void Invoke(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, MiddlewareDelegate<T1, T2, T3, T4, T5, T6, T7> next);
        /// <summary>
        /// Invokes the middleware.
        /// </summary>
        /// <param name="t1">The first input for the middleware.</param>
        ...
        Task InvokeAsync(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, MiddlewareDelegate<T1, T2, T3, T4, T5, T6, T7> next);
    }
}
