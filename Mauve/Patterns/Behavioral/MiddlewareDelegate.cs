...
{
    /// <summary>
    /// Represents a method for invoking middleware.
    /// </summary>
    ...
    /// Represents a method for invoking middleware.
    /// </summary>
    /// <typeparam name="T">The first type the delegate works with.</typeparam>
    /// <param name="input">The first parameter for the delegate.</param>
    /// <returns>A <see cref="Task"/> describing the result of the invocation.</returns>
